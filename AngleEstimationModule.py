...
def main(video, pEstimate, finalCheck):
    ...
    def successCheck(angle, side):
        ...
        if side == 'rightBottom':
            ...
            percentage = np.interp(angle, (178, 120), (100, 0))
            ##
        ...
        # Left Side    
            ...
            # Converting the angle to percentage
            percentage = np.interp(angle, (175,240), (0, 100))
            ##
        ...
        # Specifically checking for the bending the knee after successful 
        # landing 
        # Left Leg
        elif side == 'leftTop':
            successLanding = 0
            # Converting the angle to percentage
            percentage = np.interp(angle, (160,105), (100, 0))
            ##
        ...
        # Right Leg    
            ...
            successLanding = 0
            # Converting the angle to percentage
            percentage = np.interp(angle, (260,250), (0, 100))
            ##
    ...
    while True:
        ...
        if frame is not None:
            ...
            if len(xyList) != 0:
                ...
                passCheckRightTop.append(successCheck(angleRightTop,'rightTop'))
                ##
