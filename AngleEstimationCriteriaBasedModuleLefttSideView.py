...
def main(video, pEstimate, finalCheck, rotate = False):
    ...
    def successCheck(angle, side):
        ...
        if side == 'leftBottom':
            ...
            percentage = np.interp(angle, (175, 68), (100, 0))
            ##
        ...
        # Left Side
            ...
            # Converting the angle to percentage
            percentage = np.interp(angle, (320,300), (100, 0))
            ##
    ...
    while True:
        ...
        if frame is not None:
            ...
            if len(xyList) != 0:
                ...
                angleLeftTop = pEstimate.toFindAngle(frame, 11, 23, 25, True)
                ##
                ...
                passCheckLeftBottom.append(successCheck(angleLeftBottom, 
                                                         'leftBottom'))
                passCheckLeftTop.append(successCheck(angleLeftTop, 
                                                      'leftTop'))
                ##
                ...
                for each in finalCheck:
                    ...
                    if each == 'leftBottom':
                        if 1 in passCheckLeftBottom:
                            writeText('Left Bottom', True, (150,50), (150,120))
                        else:
                            writeText('Left Bottom', False, (150,50), (150,120))
                    else:
                        if 1 in passCheckLeftTop:
                            writeText('Left Top', True, (530,50), (530,120))
                        else:
                            writeText('Left Top', False, (530,50), (530,120))
                    ##
                ##
            ##
...
if __name__ == "__main__":
    ...
    passCheckLeftTop = []
    passCheckRightTop = []
    finalCheck = ['leftBottom', 'leftTop']
    
    # Video as input for the initiating the estimation
    video = cv2.VideoCapture('Pose Estimation/pose2_l.avi')
    ##
